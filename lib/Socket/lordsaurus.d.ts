...
declare class lordsaurus {
    constructor(
        utils: lordsaurus.Utils,
        waUploadToServer: lordsaurus.WAMediaUploadFunction,
        relayMessageFn?: (jid: string, content: any, options?: any) => Promise<any>
    );
    
    detectType(content: lordsaurus.MessageContent): 'PAYMENT' | 'PRODUCT' | 'INTERACTIVE' | 'ALBUM' | 'EVENT' | 'POLL_RESULT' | 'GROUP_STORY' | 'STICKER_PACK' | null;

    handlePayment(
        content: { requestPaymentMessage: lordsaurus.PaymentMessage },
        quoted?: proto.IWebMessageInfo
    ): Promise<{ requestPaymentMessage: proto.Message.RequestPaymentMessage }>;
handleStickerPack(
        content: { stickerPack: lordsaurus.StickerPack },
        jid: string,
        quoted?: proto.IWebMessageInfo
    ): Promise<{ stickerPackMessage: any }>;
    handleProduct(
        content: { productMessage: lordsaurus.ProductMessage },
        jid: string,
        quoted?: proto.IWebMessageInfo
    ): Promise<{ viewOnceMessage: proto.Message.ViewOnceMessage }>;

    handleInteractive(
        content: { interactiveMessage: lordsaurus.InteractiveMessage },
        jid: string,
        quoted?: proto.IWebMessageInfo
    ): Promise<{ interactiveMessage: proto.Message.InteractiveMessage }>;

    handleAlbum(
        content: { albumMessage: lordsaurus.AlbumItem[] },
        jid: string,
        quoted?: proto.IWebMessageInfo
    ): Promise<any>;

    handleEvent(
        content: { eventMessage: lordsaurus.EventMessage },
        jid: string,
        quoted?: proto.IWebMessageInfo
    ): Promise<any>;
    
    handlePollResult(
        content: { pollResultMessage: lordsaurus.PollResultMessage },
        jid: string,
        quoted?: proto.IWebMessageInfo
    ): Promise<any>;

    handleGroupStory(
        content: { groupStatusMessage: lordsaurus.GroupStatusMessage },
        jid: string,
        quoted?: proto.IWebMessageInfo
    ): Promise<any>;
    ...
    buildMessageContent(
        content: any,
        opts?: lordsaurus.WAMessageContentGenerationOptions
    ): Promise<any>;

    utils: lordsaurus.Utils;
    relayMessage: (jid: string, content: any, options?: any) => Promise<any>;
    waUploadToServer: lordsaurus.WAMediaUploadFunction;
    bail: lordsaurus.BailUtils;
}
